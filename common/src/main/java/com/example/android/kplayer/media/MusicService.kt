...
package com.example.android.kplayer.media
...
import com.example.android.kplayer.media.extensions.toMediaQueueItem
import com.example.android.kplayer.media.extensions.toMediaSource
import com.example.android.kplayer.media.extensions.trackNumber
import com.example.android.kplayer.media.library.AbstractMusicSource
import com.example.android.kplayer.media.library.BrowseTree
import com.example.android.kplayer.media.library.JsonSource

import com.example.android.kplayer.media.library.MEDIA_SEARCH_SUPPORTED
import com.example.android.kplayer.media.library.MusicSource
import com.example.android.kplayer.media.library.UAMP_BROWSABLE_ROOT
import com.example.android.kplayer.media.library.UAMP_EMPTY_ROOT
import com.example.android.kplayer.media.library.UAMP_RECENT_ROOT
...
open class MusicService : MediaBrowserServiceCompat() {
    ...
    override fun onCreate() {
        ...
        mediaSource = JsonSource(source = remoteJsonSource, context = applicationContext)
        serviceScope.launch {
            mediaSource.load()
//            localmediaSource.load()
        }
...
//            localmediaSource.whenReady {
//                val itemToPlay: MediaMetadataCompat? = localmediaSource.find { item ->
//                    item.id == mediaId
//                }
//                if (itemToPlay == null) {
//                    Log.w(TAG, "Local Content not found: MediaID=$mediaId")
//
//                } else {
//
//                    val playbackStartPositionMs =
