...
/**
 * RecyclerView adapter for browsing music in Android Auto projection mode.
        ...
        fun bind(mediaItem: MediaItem) {
            binding.apply {
                ...
                Glide.with(albumArt.context)
                    ...
                    .apply(
                        RequestOptions()
                            .placeholder(com.example.android.uamp.R.drawable.ic_album_black_24dp)
                            .error(com.example.android.uamp.R.drawable.ic_album_black_24dp)
